...
const SideBar = ({ setShowSideBar, sideBarRef, showSideBar }) => {
  ...
  return (
    <div
      ref={sideBarRef}
      className="bg-[#202123] relative z-50 ct-transition side-bar-enter-done"
    >
      <div className="flex flex-col p-2 h-[calc(100dvh-60px)]">
        <div
          className={`flex gap-2 ct-transition ${showSideBar ? "" : "hidden"}`}
        >
          <SidebarButton className="justify-start flex-grow" to={"/"}>
            <svg
              stroke="currentColor"
              fill="none"
              strokeWidth="2"
        ...
        <div className="list-conversation flex flex-col gap-3 mt-1 overflow-y-auto xl:overflow-y-auto xl:hover:overflow-y-auto scroll-m-[10px]">
          {/* <div>
